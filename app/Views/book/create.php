					...
					<div class="row">
						...
						<div class="col-12">
							...
							<div class="form-group">
								...
								<textarea name="description" autocomplete="off" id="Description" cols="30" rows="5" class="form-control form-control-alternative" placeholder="Description"><?= isset($data['description']) ? $data['description']: '' ?></textarea>
							</div>
						</div>
						<div class="col-6">
							<div class="form-group">
